...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $categoryTree, $registry, $categoryFactory, $jsonEncoder, $resourceHelper,
            $backendSession, $data);
    ...
    protected function _getNodeJson($node, $level = 0)
    {
        ...
        if (!empty($storeIds) && !in_array(0, $storeIds) && !is_null($this->_blogStore) && !in_array($this->_blogStore,
                $storeIds)) {
            return null;
        }
