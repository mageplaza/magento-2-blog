    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_blog_post_tag')) {
            $table = $installer->getConnection()
                ...
                ->addIndex(
                    $installer->getIdxName('mageplaza_blog_post_tag', ['post_id', 'tag_id'],
        ...
        if (!$installer->tableExists('mageplaza_blog_post_topic')) {
            $table = $installer->getConnection()
                ...
                ->addIndex(
                    $installer->getIdxName('mageplaza_blog_post_topic', ['post_id', 'topic_id'],
                        AdapterInterface::INDEX_TYPE_UNIQUE),
                    ['post_id', 'topic_id'],
                    ['type' => AdapterInterface::INDEX_TYPE_UNIQUE]
                )
        ...
        if (!$installer->tableExists('mageplaza_blog_post_category')) {
            $table = $installer->getConnection()
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_blog_post_category', 'category_id', 'mageplaza_blog_category',
                        'category_id'),
                    'category_id',
                ...
                ->addIndex(
                    $installer->getIdxName('mageplaza_blog_post_category', ['category_id', 'post_id'],
                        AdapterInterface::INDEX_TYPE_UNIQUE),
                    ['category_id', 'post_id'],
                    ['type' => AdapterInterface::INDEX_TYPE_UNIQUE]
                )
